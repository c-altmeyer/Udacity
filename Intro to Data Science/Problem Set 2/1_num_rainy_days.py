...
# wrong code, code actually for task 2
...
def max_temp_aggregate_by_fog(filename):
    ...
    print rainy_days
max_temp_aggregate_by_fog("C:\Users\\altmeyer\Documents\GitHub\Udacity\Intro to Data Science\Problem Set 2\weather_underground.csv")
