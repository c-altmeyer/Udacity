# -*- coding: utf-8 -*-
"""
Created on Sat Jun 13 11:53:39 2015

@author: altmeyer
"""
# works but return changed by print, else no output
...
def avg_medal_count():
    ...
    global df
    global avg_bronze_at_lest_one_gold
    ...
    fd = df[df.gold > 0]
    avg_bronze_at_least_one_gold = fd['bronze'].mean()
